...
macro_rules! app_invoke_handler {
    () => {
        tauri::generate_handler![
            ...
            commands::write_research_report_note,
            ...
            commands::grammar_issue_count,
            commands::ocr_extract_text,
            commands::ocr_extract_text_from_pdf,
            commands::fluidvoice_installed,
            commands::fluidvoice_models,
