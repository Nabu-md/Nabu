...
import {
  ...
  NabuSideMenu,
} from '@/components/nabuBlockNoteSideMenu'
...
export function renderSideMenuWithBlock(block: MockBlock | undefined, options: RenderSideMenuOptions = {}) {
  ...
  render(<NabuSideMenu locale={locale} />)
}
...
export function collapsedSectionStyleText() {
  return Array.from(document.head.querySelectorAll('style[data-nabu-collapsed-sections]'))
...
export function cleanupSideMenuTest() {
  ...
  document.head.querySelectorAll('style[data-nabu-collapsed-sections]')
