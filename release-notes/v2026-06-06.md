...
- 📝 **AI Agents Can Create Notes Directly** — OpenAI-backed note creation now works inside Nabu, making agent-driven capture and drafting feel more complete.
- 🧠 **Built-in MCP Note Creation** — Nabu now exposes a native MCP tool for creating notes, improving automation workflows that operate on the vault.
