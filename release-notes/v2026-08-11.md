...
- Fixed Nabu injecting a duplicate Pi MCP adapter when Pi configuration already loads it.
...
- Reduced telemetry noise from editor races that Nabu successfully recovers while retaining reports for unrecovered failures.
