...
- 🇵🇱 **Polish Language Support** — Use Nabu with a new Polish interface translation.
...
- ☀️ **Improved Light Mode Editing** — Read code blocks more comfortably when Nabu is using the light theme.
