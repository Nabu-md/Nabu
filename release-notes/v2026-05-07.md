...
- 💻 **New website!** – available at [Nabu.md](http://nabu.md/), now includes thorough docs and universal search with cmd+k
- 🤖 **Built-in Agent Docs** — Nabu now bundles product documentation for local AI agents so guidance is available inside the app.
