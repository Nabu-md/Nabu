...
- 📊 **Spreadsheet Notes** — Nabu can now open and edit plain-text spreadsheet notes, with formula autocomplete, keyboard navigation, copy/paste support, and documentation for the spreadsheet file format.
