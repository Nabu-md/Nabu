...
- 🪟 **Separate app windows for separate vaults** — Opening a vault can now create an independent Nabu application instance with its own runtime state, window identity, and vault lifecycle.
