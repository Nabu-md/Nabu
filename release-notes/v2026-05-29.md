...
- 🌏 **Indonesian Language Support** — Nabu now includes an Indonesian translation alongside the existing supported languages.
...
- ⚡ **Faster AI Agent Startup** — Local AI agent discovery is deferred and parallelized so opening Nabu does less blocking work up front.
