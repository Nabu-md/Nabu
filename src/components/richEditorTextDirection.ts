...
export const RICH_EDITOR_RTL_DIRECTION_CLASS = 'nabu-rich-editor-text-direction-rtl'

type RichEditorDirection = 'auto' | 'rtl'

const textDirectionPluginKey = new PluginKey<ProsemirrorDecorationSet>('nabuRichEditorTextDirection')
