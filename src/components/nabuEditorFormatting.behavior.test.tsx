...
vi.mock('./nabuEditorFormattingConfig', () => ({
  filterNabuFormattingToolbarItems: (items: ReactNode[]) => items,
...
import {
  NabuFormattingToolbar,
  NabuFormattingToolbarController,
} from './nabuEditorFormatting'
...
describe('nabuEditorFormatting behavior', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  ...
  it('opens selected file blocks through the active vault path', () => {
    ...
    render(<NabuFormattingToolbar vaultPath="/vault" />)
  ...
  it('uses block alignment when deciding the floating placement', () => {
    ...
    render(<NabuFormattingToolbarController />)
  ...
  it('adds viewport-clamping middleware and preserves caller middleware', () => {
    ...
    expect(floatingOptions.middleware.map((middleware) => middleware.name)).toEqual(
      expect.arrayContaining(['custom-middleware', 'nabuViewportClamp']),
    )
  })
  ...
  it('keeps the toolbar open during close grace and clears the timeout on unmount', () => {
    ...
    const { rerender, unmount } = render(<NabuFormattingToolbarController />)

    showState.value = false
    rerender(<NabuFormattingToolbarController />)
  ...
  it('binds composition listeners after BlockNote provides its editor element', () => {
    ...
    const { rerender } = render(<NabuFormattingToolbarController />)
