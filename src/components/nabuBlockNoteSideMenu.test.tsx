...
} from '../../tests/support/nabuBlockNoteSideMenuTestUtils'

beforeAll(installPointerEventSupport)

describe('NabuSideMenu', () => {
  ...
  it('replaces BlockNote block colors with markdown-safe drag-handle items', () => {
    ...
    expect(screen.getByTestId('menu-sub-dropdown')).toHaveClass('nabu-turn-into-menu-dropdown')
