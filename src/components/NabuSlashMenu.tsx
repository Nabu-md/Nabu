...
import type { NabuSlashMenuItem } from './nabuEditorFormattingConfig'
...
function submenuForKey(items: NabuSlashMenuItem[], key?: string) {
...
function applySubmenuKeyboardAction(options: {
  ...
  onItemClick: SuggestionMenuProps<NabuSlashMenuItem>['onItemClick']
  openItemSubmenu: (item: NabuSlashMenuItem) => void
  selectedItem?: NabuSlashMenuItem
...
export function NabuSlashMenu({
  items,
  loadingState,
  onItemClick,
  selectedIndex,
}: SuggestionMenuProps<NabuSlashMenuItem>) {
  ...
  const openItemSubmenu = useCallback((item: NabuSlashMenuItem) => {
  ...
  return (
    <>
      <Components.SuggestionMenu.Root id="bn-suggestion-menu" className="bn-suggestion-menu nabu-slash-menu">
        {renderedItems}
      ...
      {openSubmenu &&
        ...
        createPortal(
          <div
            ...
            className="nabu-slash-menu__submenu"
            role="menu"
          ...
          >
            {submenuItems.map((item, index) => (
              <Button
                ...
                className="nabu-slash-menu__submenu-item"
                key={item.key}
