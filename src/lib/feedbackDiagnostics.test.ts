...
describe('feedbackDiagnostics', () => {
  ...
  it('sanitizes recent warnings and errors before building the bundle', () => {
    ...
    console.error(`Load failed for /Users/demo/vault/private.md with token ${sampleToken}`)
    ...
    expect(bundle).toContain('Nabu sanitized diagnostics')
    ...
    expect(bundle).not.toContain('/Users/demo/vault/private.md')
