...
export interface DirectMarkdownCapableSerializer {
  ...
  __nabuDirectMarkdownCache?: WeakMap<object, Map<string, string>>
  __nabuLastDirectMarkdownMetrics?: BlockNoteDirectMarkdownMetrics
}
