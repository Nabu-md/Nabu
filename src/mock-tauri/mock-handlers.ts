...
export const mockHandlers = {
  ...
  save_settings: (args: { settings: Settings }) => {
    ...
    mockSettings = {
      ...
      sidebar_opacity: s.sidebar_opacity ?? null,
      sidebar_blur_radius: s.sidebar_blur_radius ?? null,
      editor_opacity: s.editor_opacity ?? null,
      editor_blur_radius: s.editor_blur_radius ?? null,
      ai_panel_opacity: s.ai_panel_opacity ?? null,
      ai_panel_blur_radius: s.ai_panel_blur_radius ?? null,
      window_opacity: s.window_opacity ?? null,
      window_blur_radius: s.window_blur_radius ?? null,
