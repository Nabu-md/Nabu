...
remote_workdir="${SIDECAR_REMOTE_WORKDIR:-/home/user/nabu}"
sidecar_prefix="${SIDECAR_NAME_PREFIX:-nabu-hooks}"
...
state_dir="$(mktemp -d "${TMPDIR:-/tmp}/nabu-sidecar-lanes.XXXXXX")"
